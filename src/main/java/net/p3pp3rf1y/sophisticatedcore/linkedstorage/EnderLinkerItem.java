...
public class EnderLinkerItem extends ItemBase {
	...
	public EnderLinkerItem(Item.Properties properties) {
	...
	private static TriState tryLinkBlock(Player player, ItemStack linker, Level level, BlockPos pos) {
	...
	public void inventoryTick(ItemStack stack, Level level, Entity entity, int slotId, boolean isSelected) {
		if (level instanceof ServerLevel serverLevel && stack.has(ModCoreDataComponents.ENDER_LINK_PENDING_CRAFT)
