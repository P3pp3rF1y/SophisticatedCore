...
public class GuiHelper {
	...
	public static void renderTabBackground(GuiGraphics guiGraphics, int x, int y, int width, int height) {
		...
		if (width <= GUI_CONTROLS_TEXTURE_WIDTH / 2) {
			...
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x - 3, y, (float) (GUI_CONTROLS_TEXTURE_WIDTH / 2),
	...
	public static void renderTooltip(Screen screen, GuiGraphics guiGraphics, ItemStack tooltipStack, List<Component> components,
