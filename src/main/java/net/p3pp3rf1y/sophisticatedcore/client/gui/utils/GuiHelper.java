...
public class GuiHelper {
	...
	public static void writeTooltipLines(GuiGraphics guiGraphics, List<FormattedCharSequence> textLines, Font font, float leftX, int topY, Matrix4f matrix4f,
	...
	public static void renderTabBackground(GuiGraphics guiGraphics, int x, int y, int width, int height) {
		...
		if (width <= GUI_CONTROLS_TEXTURE_WIDTH / 2) {
			guiGraphics.blit(GUI_CONTROLS, x, y, (float) GUI_CONTROLS_TEXTURE_WIDTH - width, 0, width, halfHeight, GUI_CONTROLS_TEXTURE_WIDTH,
					GUI_CONTROLS_TEXTURE_HEIGHT);
			guiGraphics.blit(GUI_CONTROLS, x, y + halfHeight, (float) GUI_CONTROLS_TEXTURE_WIDTH - width,
			...
			guiGraphics.blit(GUI_CONTROLS, x - 3, y, GUI_CONTROLS_TEXTURE_WIDTH / 2, GUI_CONTROLS_TEXTURE_HEIGHT - height, 3, height);
			return;
		}
	...
	public static void renderTiledControlBackground(GuiGraphics guiGraphics, int x, int y, int width, int height, int u, int v, int textureWidth,
		...
		guiGraphics.blit(GUI_CONTROLS, x, y, (float) u, (float) v, leftWidth, topHeight, GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(GUI_CONTROLS, x + leftWidth + centerWidth, y, (float) sourceRightU, (float) v, rightWidth, topHeight, GUI_CONTROLS_TEXTURE_WIDTH,
				GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(GUI_CONTROLS, x, y + topHeight + centerHeight, (float) u, (float) sourceBottomV, leftWidth, bottomHeight, GUI_CONTROLS_TEXTURE_WIDTH,
				GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(GUI_CONTROLS, x + leftWidth + centerWidth, y + topHeight + centerHeight, (float) sourceRightU, (float) sourceBottomV, rightWidth,
				bottomHeight, GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
	...
	private static void renderTiledTexture(GuiGraphics guiGraphics, int x, int y, int width, int height, int u, int v, int textureWidth, int textureHeight) {
		...
		while (renderedY < height) {
			...
			while (renderedX < width) {
				...
				guiGraphics.blit(GUI_CONTROLS, x + renderedX, y + renderedY, (float) u, (float) v, chunkWidth, chunkHeight, GUI_CONTROLS_TEXTURE_WIDTH,
						GUI_CONTROLS_TEXTURE_HEIGHT);
	...
	public static void renderControlBackground(GuiGraphics guiGraphics, int x, int y, int renderWidth, int renderHeight, int u, int v, int textureBgWidth,
		...
		guiGraphics.blit(GUI_CONTROLS, x, y, u, v, halfWidth, halfHeight, GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(GUI_CONTROLS, x, y + halfHeight, u, (float) v + textureBgHeight - halfHeight, halfWidth, halfHeight, GUI_CONTROLS_TEXTURE_WIDTH,
				GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(GUI_CONTROLS, x + halfWidth, y, (float) u + textureBgWidth - halfWidth, v, halfWidth, halfHeight, GUI_CONTROLS_TEXTURE_WIDTH,
				GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(GUI_CONTROLS, x + halfWidth, y + halfHeight, (float) u + textureBgWidth - halfWidth, (float) v + textureBgHeight - halfHeight,
				halfWidth, halfHeight, GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
	}

	public static void tryRenderGuiItem(GuiGraphics guiGraphics, ItemRenderer itemRenderer, @Nullable LivingEntity livingEntity, ItemStack stack, int x, int y,
			int rotation) {
		if (!stack.isEmpty()) {
