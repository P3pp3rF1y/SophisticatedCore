...
public class ModRecipes {
	...
	public static final Supplier<SimpleCraftingRecipeSerializer<?>> ENDER_LINKER_ENDPOINT_SERIALIZER = RECIPE_SERIALIZERS.register("ender_linker_endpoint",
			() -> new SimpleCraftingRecipeSerializer<>(EnderLinkerEndpointRecipe::new));
	public static final Supplier<SimpleCraftingRecipeSerializer<?>> ENDER_LINKER_CLEAR_SERIALIZER = RECIPE_SERIALIZERS.register("ender_linker_clear",
