...
public class ModRecipes {
	...
	private static final DeferredRegister<Codec<? extends ICondition>> CONDITION_CODECS = DeferredRegister.create(NeoForgeRegistries.Keys.CONDITION_CODECS, SophisticatedCore.MOD_ID);
	...
	public static final Supplier<Codec<ItemEnabledCondition>> ITEM_ENABLED_CONDITION = CONDITION_CODECS.register("item_enabled", () -> ItemEnabledCondition.CODEC);
}
