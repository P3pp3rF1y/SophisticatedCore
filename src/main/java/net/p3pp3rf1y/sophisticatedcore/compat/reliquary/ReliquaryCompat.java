...
public class ReliquaryCompat implements ICompat {
	...
	public void setup() {
		AlchemyUpgradeWrapper.addItemDefinition(new AlchemyUpgradeWrapper.AlchemyItemDefinition(stack -> stack.getItem() == ModItems.POTION.get(),
				AlchemyUpgradeWrapper::getDefaultConditionForPotion, AlchemyUpgradeWrapper::shouldApplyPotionEffectsTo,
				AlchemyUpgradeWrapper::stackPotionEffectsMatch, ItemStack::getUseDuration, (stack, livingEntity) -> {
		...
		AlchemyUpgradeWrapper.addItemDefinition(new AlchemyUpgradeWrapper.AlchemyItemDefinition(stack -> stack.getItem() == ModItems.SPLASH_POTION.get(),
				AlchemyUpgradeWrapper::getDefaultConditionForPotion, AlchemyUpgradeWrapper::shouldApplyPotionEffectsTo,
				AlchemyUpgradeWrapper::stackPotionEffectsMatch, (stack, livingEntity) -> {
					...
					ThrownPotion thrownPotion = new ThrownPotion(level, new Vec3(livingEntity.getX() + livingEntity.getBbWidth() / 2,
