...
public class BlockTransformationUpgradeTab extends UpgradeSettingsTab<BlockTransformationUpgradeContainer> {
	...
	public BlockTransformationUpgradeTab(BlockTransformationUpgradeContainer upgradeContainer, Position position, StorageScreenBase<?> screen,
			ButtonDefinition.Toggle<Boolean> shiftClickTargetButton, ButtonDefinition.Toggle<Boolean> refillInputButton, String upgradeName) {
		super(upgradeContainer, position, screen, TranslationHelper.INSTANCE.translUpgrade(upgradeName),
