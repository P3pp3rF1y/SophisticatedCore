...
public abstract class SettingsHandler {
	...
	protected SettingsHandler(ContainerContents.SettingsData settingsData, Runnable markContentsDirty, Supplier<InventoryHandler> inventoryHandlerSupplier,
			Supplier<RenderDataHandler> renderDataHandlerSupplier, String playerSettingsName) {
	...
	protected <D extends ContainerContents.ISettingsCategoryData<D>, T extends ISettingsCategory<T, D>> void addSettingsCategory(
			ContainerContents.SettingsData settingsData, String categoryName, Runnable markContentsDirty, BiFunction<D, Runnable, T> instantiateCategory,
	...
	private static <D extends ContainerContents.ISettingsCategoryData<D>> D getSettingsCategoryData(ContainerContents.SettingsData settingsData,
			String categoryName, Supplier<D> defaultDataSupplier) {
		// noinspection unchecked
	...
	private static <D extends ContainerContents.ISettingsCategoryData<D>> void reloadFrom(ISettingsCategory<?, D> category,
			ContainerContents.ISettingsCategoryData<?> data) {
		// noinspection unchecked
