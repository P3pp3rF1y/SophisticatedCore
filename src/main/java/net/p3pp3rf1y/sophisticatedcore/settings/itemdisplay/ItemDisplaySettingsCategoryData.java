...
public class ItemDisplaySettingsCategoryData implements ContainerContents.ISettingsCategoryData<ItemDisplaySettingsCategoryData> {
	...
	public ItemDisplaySettingsCategoryData copy() {
		return new ItemDisplaySettingsCategoryData(color, new LinkedList<>(slotIndexes), new HashMap<>(slotRotations), displaySide);
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(color, slotIndexes, slotRotations, displaySide);
	}
}
