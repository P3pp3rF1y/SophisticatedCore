...
public class ItemDisplaySettingsTab extends SettingsTab<ItemDisplaySettingsContainer> {
	...
	public void renderDefaultItemDisplaySettingsPreview(GuiGraphicsExtractor guiGraphics, int x, int y, int width, int height,
		...
		provider.getItemDisplaySettingsPreviewStack(screen, container, selectedSlot).ifPresent(stack -> {
			...
			extractItemDisplayPreviewItem(guiGraphics, stack, x, y, width, height, xAxisRotation, previewYAxisRotation,
					provider.getItemDisplayPreviewScaleMultiplier());
		});
	}

	public void extractItemDisplayPreviewItem(GuiGraphicsExtractor guiGraphics, ItemStack stack, int x, int y, int width, int height, float xAxisRotation,
		...
		minecraft.getItemModelResolver().updateForTopItem(renderState, stack, ItemDisplayContext.NONE, null, null, 0);
	...
	public void renderWithItemDisplayPreviewLighting(GuiGraphicsExtractor guiGraphics, Runnable renderPreview) {
		renderPreview.run();
	}
