...
import net.p3pp3rf1y.sophisticatedcore.client.render.ItemPreviewRenderState;
...
public class ItemDisplaySettingsTab extends SettingsTab<ItemDisplaySettingsContainer> {
	...
	public void renderItemDisplayPreviewItem(GuiGraphics guiGraphics, ItemStack stack, int x, int y, int width, int height, float xAxisRotation,
		...
		guiGraphics.submitPictureInPictureRenderState(new ItemPreviewRenderState(stack, xAxisRotation, yAxisRotation, scale, new Matrix3x2f(guiGraphics.pose()),
				guiGraphics.peekScissorStack(), x, y, x + width, y + height));
	}
