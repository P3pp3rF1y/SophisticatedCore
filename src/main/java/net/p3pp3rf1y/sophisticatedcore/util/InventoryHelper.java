...
public class InventoryHelper {
	...
	static {
		...
		registerEquipmentInventoryProvider(player -> new CombinedInvWrapper(new PlayerArmorInvWrapper(player.getInventory()),
				new PlayerOffhandInvWrapper(player.getInventory()), new RangedWrapper(new InvWrapper(player.getInventory()),
						player.getInventory().getSelectedSlot(), player.getInventory().getSelectedSlot() + 1)));
	}
