...
public class InventoryPartRegistry {
	...
	static {
		registerFactory(IInventoryPartHandler.Default.NAME,
				(parent, slotRange, getMemorySettings) -> new IInventoryPartHandler.Default(parent, slotRange.numberOfSlots()));
	}
	...
	public static IInventoryPartHandler instantiatePart(String name, InventoryHandler parent, SlotRange slotRange,
