...
public class XpPumpUpgradeConfig {
	...
	public XpPumpUpgradeConfig(ForgeConfigSpec.Builder builder) {
		...
		mendingOn = builder.comment("Whether xp pump can mend items with mending. Set false here to turn off the feature altogether.").define("mendingOn",
				true);
		maxXpPointsPerMending = builder.comment(
