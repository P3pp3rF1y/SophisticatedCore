...
public class AlchemyUpgradeWrapper extends UpgradeWrapperBase<AlchemyUpgradeWrapper, AlchemyUpgradeItem> implements ITickableUpgrade {
	...
	private static List<AlchemyItemDefinition> itemDefinitions = List.of(
			...
			new AlchemyItemDefinition(stack -> {
				...
				return false;
			}, AlchemyUpgradeWrapper::foodStackPotionEffectsMatch, ItemStack::getUseDuration, (stack, livingEntity) -> stack.getItem().finishUsingItem(stack, livingEntity.level(), livingEntity))
	);
	...
	private static boolean matchEffectIn(FoodProperties foodProperties, FoodProperties.PossibleEffect filterEffect, boolean matchEffectDuration, boolean matchEffectAmplifier) {
