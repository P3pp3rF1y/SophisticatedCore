...
public class StonecutterUpgradeContainer extends BlockConverterUpgradeContainer<StonecutterRecipe, StonecutterUpgradeItem.Wrapper, StonecutterUpgradeContainer, StonecutterRecipeContainer> {
	public StonecutterUpgradeContainer(Player player, int upgradeContainerId, StonecutterUpgradeItem.Wrapper upgradeWrapper, UpgradeContainerType<StonecutterUpgradeItem.Wrapper, StonecutterUpgradeContainer> type) {
