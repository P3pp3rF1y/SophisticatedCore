...
public class MagnetUpgradeContainer extends UpgradeContainerBase<MagnetUpgradeWrapper, MagnetUpgradeContainer> {
	...
	public MagnetUpgradeContainer(Player player, int containerId, MagnetUpgradeWrapper wrapper,
	...
	public void handlePacket(CompoundTag data) {
		data.getBoolean(DATA_PICKUP_ITEMS).ifPresent(this::setPickupItems);
		data.getBoolean(DATA_PICKUP_XP).ifPresent(this::setPickupXp);
