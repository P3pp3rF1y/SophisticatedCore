...
public class VoidUpgradeTab extends UpgradeSettingsTab<VoidUpgradeContainer> {
	private static final TranslatableComponent VOID_OVERFLOW_TOOLTIP = new TranslatableComponent(TranslationHelper.INSTANCE.translUpgradeButton("void_overflow"));
	private static final MutableComponent VOID_OVERFLOW_TOOLTIP_DETAIL = new TranslatableComponent(TranslationHelper.INSTANCE.translUpgradeButton("void_overflow.detail")).withStyle(ChatFormatting.GRAY);

	private static final MutableComponent VOID_ANYTHING_DISABLED_TOOLTIP = new TranslatableComponent(TranslationHelper.INSTANCE.translUpgradeButton("void_anything_disabled")).withStyle(ChatFormatting.RED);
